...
function faveColorFinder(color){
  ...
  return ('you need to evlauate you favorite color choice')
}
}
...
function bigOrSmall (arr) {
  ...
  let ans = bigOrSmall(bigOrSmallArray);
    console.log(ans); 
...
function emailCheck(email) {
  ...
  if (email.includes('@')) {
    ...
    return "must provvied a valid email address"
  }
}
...
let totalFrogs = frogPurchaser(30)
////////////////// PROBLEM 20 ////////////////////
/*
...
let totalFrogs2 = frogPurchaser2 (30)
////////////////// PROBLEM 21 ////////////////////
